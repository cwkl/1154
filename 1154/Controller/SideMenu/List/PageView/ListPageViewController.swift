...
class ListPageViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate {
    ...
    lazy var viewControllerList: [UIViewController] = {
        ...
        let page1 = storyBoard.instantiateViewController(withIdentifier: "LikeTableViewController")
        page1.view.tag = 0
        if let like = page1 as? LikeTableViewController{
            like.pagerView = self
        }
        let page2 = storyBoard.instantiateViewController(withIdentifier: "BookmarkTableViewController")
        page2.view.tag = 1
        if let bookmark = page2 as? BookmarkTableViewController {
            bookmark.pagerView = self
        }
