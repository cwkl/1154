//
//  TrevelTableViewController.swift
//  1154
//
...
class TrevelTableViewController: UIViewController, TableViewCellDelegate {
    ...
    func tableViewLoad() {
        DispatchQueue.global().async {
            ...
            if self.country == "all" {
                whereField = Firestore.firestore().collection("submit").whereField("category", isEqualTo: "trevel")
            }else if self.country == "korea"{
                whereField = Firestore.firestore().collection("submit").whereField("category", isEqualTo: "trevel").whereField("country", isEqualTo: "korea")
            }else if self.country == "japan"{
                whereField = Firestore.firestore().collection("submit").whereField("category", isEqualTo: "trevel").whereField("country", isEqualTo: "japan")
            }
...
extension TrevelTableViewController: UITableViewDelegate, UITableViewDataSource{
